...
// public class AddItemController extends Application {
...
public class AddItemController  {
    ...
    private void handleAddButtonClick() {
        ...
        String sql = "INSERT INTO items (name, count, description, item_id) VALUES ('" + name + "', '" + count + "', '" + description + "', '" + item_id + "')";
        // execute sql
        ...
        popup.initOwner(addButton.getScene().getWindow());
        popup.initModality(Modality.APPLICATION_MODAL);
        VBox root = new VBox();
        root.getChildren().add(new Label("Item added successfully!"));
